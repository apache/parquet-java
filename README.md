...
```
wget -nv http://archive.apache.org/dist/thrift/0.17.0/thrift-0.17.0.tar.gz
...
If you're on OSX and use homebrew, you can instead install Thrift 0.17.0 with `brew` and ensure that it comes first in your `PATH`.

```
brew install thrift
export PATH="/usr/local/opt/thrift@0.17.0/bin:$PATH"
```
