...
chmod +x ./configure
./configure --disable-gen-erl --disable-gen-hs --without-ruby --without-haskell --without-erlang --without-php --without-nodejs --without-java --without-go --without-c --without-cpp --without-python --without-py3
sudo make install
cd ..
