...
public class BenchmarkFiles {
  ...
  public static final Path file_100K_NOCHECKSUMS_UNCOMPRESSED =
      new Path(TARGET_DIR + "/PARQUET-100K-NOCHECKSUMS-UNCOMPRESSED");
  public static final Path file_1M_CHECKSUMS_UNCOMPRESSED =
      new Path(TARGET_DIR + "/PARQUET-1M-CHECKSUMS-UNCOMPRESSED");
  public static final Path file_1M_NOCHECKSUMS_UNCOMPRESSED =
      new Path(TARGET_DIR + "/PARQUET-1M-NOCHECKSUMS-UNCOMPRESSED");
  public static final Path file_10M_CHECKSUMS_UNCOMPRESSED =
      new Path(TARGET_DIR + "/PARQUET-10M-CHECKSUMS-UNCOMPRESSED");
  public static final Path file_10M_NOCHECKSUMS_UNCOMPRESSED =
      new Path(TARGET_DIR + "/PARQUET-10M-NOCHECKSUMS-UNCOMPRESSED");
