  ...
  public static class Builder {
    ...
    public void add(int repetitionLevel, int definitionLevel) {
      Preconditions.checkArgument(
          0 <= repetitionLevel && repetitionLevel < repetitionLevelHistogram.length,
          "repetitionLevel %s is out of range [0, %s]",
          repetitionLevel,
          repetitionLevelHistogram.length - 1);
      Preconditions.checkArgument(
          definitionLevel < definitionLevelHistogram.length,
          "definitionLevel %s is out of range [0, %s]",
          definitionLevel,
          definitionLevelHistogram.length - 1);
