 ...
 * under the License.
 */
package org.apache.parquet.example.data.singlevalue;
...
public class SingleValueGroup extends Group {

  private final GroupType schema;
  private final Object[] data;

  @SuppressWarnings("unchecked")
  public SingleValueGroup(GroupType schema) {
    this.schema = schema;
     ...
     // if (values != null) {
       ...
       //   for (Object value : values) {
            ...
            if (value == null) {
              ...
              result += "\n" + ((SingleValueGroup)value).toString(indent+"  ");
            } else {
  ...
  public Group addGroup(int fieldIndex) {
    SingleValueGroup g = new SingleValueGroup(schema.getType(fieldIndex).asGroupType());
    add(fieldIndex, g);
    return g;
  }
