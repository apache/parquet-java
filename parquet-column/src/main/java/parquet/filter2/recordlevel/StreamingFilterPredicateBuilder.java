 ...
 *
 * Constructs a {@link StreamingFilterPredicate} from a {@link parquet.filter2.predicate.FilterPredicate}
...
public class StreamingFilterPredicateBuilder implements Visitor<StreamingFilterPredicate> {
  ...
  public StreamingFilterPredicate visit(And and) {
    return new StreamingFilterPredicate.And(and.getLeft().accept(this), and.getRight().accept(this));
  }

  @Override
  public StreamingFilterPredicate visit(Or or) {
    return new StreamingFilterPredicate.Or(or.getLeft().accept(this), or.getRight().accept(this));
  }
