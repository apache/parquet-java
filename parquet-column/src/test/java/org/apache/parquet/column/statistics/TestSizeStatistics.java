...
public class TestSizeStatistics {
  ...
  public void testAddBinaryType() {
    PrimitiveType type = Types.optional(PrimitiveType.PrimitiveTypeName.BINARY).as(OriginalType.UTF8).named("a");
    final int maxRepetitionLevel = 2;
    final int maxDefinitionLevel = 2;
    SizeStatistics.Builder builder = new SizeStatistics.Builder(type, maxRepetitionLevel, maxDefinitionLevel);
    builder.add(0, 2, Binary.fromString("a"));
    builder.add(1, 2, Binary.fromString(""));
    builder.add(2, 2, Binary.fromString("bb"));
    Assert.assertThrows(IllegalArgumentException.class, () -> builder.add(3, 0, Binary.fromString("c")));
    Assert.assertThrows(IllegalArgumentException.class, () -> builder.add(0, 3, Binary.fromString("c")));
    SizeStatistics statistics = builder.build();
    Assert.assertEquals(Optional.of(3L), statistics.getUnencodedByteArrayDataBytes());
    Assert.assertEquals(Arrays.asList(1L, 1L, 1L), statistics.getRepetitionLevelHistogram());
    Assert.assertEquals(Arrays.asList(0L, 0L, 3L), statistics.getDefinitionLevelHistogram());
  }

  @Test
  public void testAddNonBinaryType() {
    PrimitiveType type = Types.optional(PrimitiveType.PrimitiveTypeName.FIXED_LEN_BYTE_ARRAY).length(2).named("a");
  ...
  public void testMergeStatistics() {
    ...
    final int maxRepetitionLevel = 2;
    final int maxDefinitionLevel = 2;
    SizeStatistics.Builder builder1 = new SizeStatistics.Builder(type, maxRepetitionLevel, maxDefinitionLevel);
    ...
    SizeStatistics.Builder builder2 = new SizeStatistics.Builder(type, maxRepetitionLevel, maxDefinitionLevel);
  ...
  public void testMergeThrowException() {
    ...
    {
      PrimitiveType type1 = Types.optional(PrimitiveType.PrimitiveTypeName.BINARY).as(OriginalType.UTF8).named("a");
      PrimitiveType type2 = Types.optional(PrimitiveType.PrimitiveTypeName.INT32).named("a");
      SizeStatistics.Builder builder1 = new SizeStatistics.Builder(type1, 1, 1);
      SizeStatistics.Builder builder2 = new SizeStatistics.Builder(type2, 1, 1);
      SizeStatistics statistics1 = builder1.build();
      SizeStatistics statistics2 = builder2.build();
    ...
    {
      PrimitiveType type = Types.optional(PrimitiveType.PrimitiveTypeName.BINARY).as(OriginalType.UTF8).named("a");
      SizeStatistics.Builder builder1 = new SizeStatistics.Builder(type, 1, 1);
      SizeStatistics.Builder builder2 = new SizeStatistics.Builder(type, 2, 2);
      SizeStatistics statistics1 = builder1.build();
      SizeStatistics statistics2 = builder2.build();
      Assert.assertThrows(IllegalArgumentException.class, () -> statistics1.mergeStatistics(statistics2));
    }
