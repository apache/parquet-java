...
public class TestTypeBuilders {
  ...
  public void testMapWithListKey() {
    ...
    typeList.add(new GroupType(REQUIRED, "key", OriginalType.LIST,
        new GroupType(REPEATED,
            "list",
  ...
  @Test
  public void testMapWithListKeyAndGroupValue() {
    List<Type> typeList = new ArrayList<Type>();
    ...
    typeList.add(new GroupType(REQUIRED, "key", OriginalType.LIST,
        new GroupType(REPEATED,
            "list",
            new PrimitiveType(REQUIRED, INT64, "element"))));
    typeList.add(new GroupType(OPTIONAL, "value", new PrimitiveType(REQUIRED, INT64, "first")));
    GroupType map = new GroupType(OPTIONAL, "myMap", OriginalType.MAP, new GroupType(REPEATED, "map",
        typeList));
  ...
  @Test
  public void testMapWithListKeyAndMapValue() {
    List<Type> typeList = new ArrayList<Type>();
    ...
    typeList.add(new GroupType(REQUIRED, "key", OriginalType.LIST,
        new GroupType(REPEATED,
            "list",
            new PrimitiveType(REQUIRED, INT64, "element"))));
    typeList.add(new GroupType(OPTIONAL, "value", OriginalType.MAP, new GroupType(REPEATED,
        "map", new Type[] {
        new PrimitiveType(REQUIRED, INT64, "key"),
  ...
  @Test
  public void testMapWithListKeyAndListValue() {
    List<Type> typeList = new ArrayList<Type>();
    ...
    typeList.add(new GroupType(REQUIRED, "key", OriginalType.LIST,
        new GroupType(REPEATED,
            "list",
            new PrimitiveType(REQUIRED, INT64, "element"))));
    typeList.add(new GroupType(OPTIONAL, "value", OriginalType.LIST, new GroupType(REPEATED,
        "list", new PrimitiveType(REQUIRED, INT32, "element"))));
    GroupType map = new GroupType(OPTIONAL, "myMap", OriginalType.MAP, new GroupType(REPEATED, "map",
        typeList));
  ...
  @Test
  public void testMapWithListKeyAndRequiredValue() {
    List<Type> typeList = new ArrayList<Type>();
  ...
  @Test
  public void testMapWithListKeyAndRequiredGroupValue() {
    List<Type> typeList = new ArrayList<Type>();
    ...
    typeList.add(new GroupType(REQUIRED, "key", OriginalType.LIST,
        new GroupType(REPEATED,
            "list",
            new PrimitiveType(REQUIRED, INT64, "element"))));
    typeList.add(new GroupType(REQUIRED, "value", new PrimitiveType(REQUIRED, INT64, "first")));
    GroupType map = new GroupType(OPTIONAL, "myMap", OriginalType.MAP, new GroupType(REPEATED, "map",
        typeList));
  ...
  @Test
  public void testMapWithListKeyAndRequiredMapValue() {
    List<Type> typeList = new ArrayList<Type>();
    ...
    typeList.add(new GroupType(REQUIRED, "key", OriginalType.LIST,
        new GroupType(REPEATED,
            "list",
            new PrimitiveType(REQUIRED, INT64, "element"))));
    typeList.add(new GroupType(REQUIRED, "value", OriginalType.MAP, new GroupType(REPEATED,
        "map", new Type[] {
        new PrimitiveType(REQUIRED, INT64, "key"),
        new PrimitiveType(REQUIRED, INT32, "value")
    })));
  ...
  @Test
  public void testMapWithListKeyAndRequiredListValue() {
    List<Type> typeList = new ArrayList<Type>();
    ...
    typeList.add(new GroupType(REQUIRED, "key", OriginalType.LIST,
        new GroupType(REPEATED,
            "list",
            new PrimitiveType(REQUIRED, INT64, "element"))));
    typeList.add(new GroupType(REQUIRED, "value", OriginalType.LIST, new GroupType(REPEATED,
        "list", new PrimitiveType(REQUIRED, INT32, "element"))));
    GroupType map = new GroupType(OPTIONAL, "myMap", OriginalType.MAP, new GroupType(REPEATED, "map",
        typeList));
  ...
  @Test
  public void testMapWithListGroupKey() {
    List<Type> typeList = new ArrayList<Type>();

    typeList.add(new GroupType(REQUIRED, "key", OriginalType.LIST,
        new GroupType(REPEATED,
            "list",
            new GroupType(REQUIRED, "element", new PrimitiveType(OPTIONAL, INT32, "intkey")))));
    typeList.add(new PrimitiveType(OPTIONAL, INT64, "value"));
    GroupType map = new GroupType(OPTIONAL, "myMap", OriginalType.MAP, new GroupType(REPEATED, "map",
        typeList));
    ...
    GroupType actual =
      Types.buildMessage()
        .optionalMap()
          .listKey()
            .keyGroupElement(REQUIRED)
              .optional(INT32).named("intkey")
            .optionalValue(INT64)
        .named("myMap")
      .named("mapParent");
    Assert.assertEquals(expected, actual);
  ...
  @Test
  public void testMapWithListGroupKeyAndGroupValue() {
    List<Type> typeList = new ArrayList<Type>();
  ...
  @Test
  public void testMapWithListGroupKeyAndMapValue() {
    List<Type> typeList = new ArrayList<Type>();
  ...
  @Test
  public void testMapWithListGroupKeyAndListValue() {
    List<Type> typeList = new ArrayList<Type>();
  ...
  @Test
  public void testMapWithListGroupKeyAndRequiredValue() {
    List<Type> typeList = new ArrayList<Type>();
  ...
  @Test
  public void testMapWithListGroupKeyAndRequiredGroupValue() {
    List<Type> typeList = new ArrayList<Type>();
  ...
  @Test
  public void testMapWithListGroupKeyAndRequiredMapValue() {
    List<Type> typeList = new ArrayList<Type>();
  ...
  @Test
  public void testMapWithListGroupKeyAndRequiredListValue() {
    List<Type> typeList = new ArrayList<Type>();
