...
public final class GlobExpander {
  ...
  public static List<String> expand(String globPattern) {
    return GlobExpanderImp.expand(globPattern);
  }
}

final class GlobExpanderImp implements GlobNode.Visitor<List<String>> {
  private static final GlobExpanderImp INSTANCE = new GlobExpanderImp();
  private GlobExpanderImp() { }

  public static List<String> expand(String pattern) {
    return GlobParser.parse(pattern).accept(INSTANCE);
  }
