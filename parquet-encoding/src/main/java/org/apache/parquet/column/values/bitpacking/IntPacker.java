 ...
 *
 * packing unpacking treats: - 32 values at a time - bitWidth ints at a time.
 */
public abstract class IntPacker {
  ...
  /**
   * @return the width in bits used for encoding, also how many ints are
   * packed/unpacked at a time
   */
