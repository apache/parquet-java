...
public class Consumers {
  ...
  /**
   * Delegates reading the field to TypedConsumers. There is one TypedConsumer per
   * thrift type. use {@link #onField(TFieldIdEnum, TypedConsumer)} et al. to
   * consume specific thrift fields.
   * 
  ...
  /**
   * call onField on the resulting DelegatingFieldConsumer to handle individual
   * fields
   * 
   ...
   */
  public static <T extends TBase<T, ? extends TFieldIdEnum>> ListConsumer listOf(Class<T> c,
  ...
  public static <T extends TBase<T, ? extends TFieldIdEnum>> StructConsumer struct(final Class<T> c,
