...
public class IncrementallyUpdatedFilterPredicateGenerator {
  ...
  private static final TypeInfo[] TYPES = new TypeInfo[] { new TypeInfo("Integer", "int", true),
      new TypeInfo("Long", "long", true), new TypeInfo("Boolean", "boolean", false),
      new TypeInfo("Float", "float", true), new TypeInfo("Double", "double", true),
  ...
  private void addVisitBegin(String inVar) throws IOException {
    add("  @Override\n" + "  public <T extends Comparable<T>> IncrementallyUpdatedFilterPredicate visit(" + inVar
  ...
  private void addInequalityCase(TypeInfo info, String op) throws IOException {
    ...
    add("    if (clazz.equals(" + info.className + ".class)) {\n" + "      final " + info.primitiveName + " target = ("
        + info.className + ") (Object) pred.getValue();\n" + "      final PrimitiveComparator<" + info.className
