...
public class ContextUtil {
  ...
  static {
    ...
    try {
      ...
      if (useV21) {
        ...
        MAP_CONTEXT_IMPL_CONSTRUCTOR = mapContextCls.getDeclaredConstructor(Configuration.class, TaskAttemptID.class,
            RecordReader.class, RecordWriter.class, OutputCommitter.class, StatusReporter.class, InputSplit.class);
        ...
        try {
          ...
          Method getCounterMethodForTaskAttemptContext = taskAttemptContextClass.getMethod("getCounter", String.class,
              String.class);
          ...
          Method getCounterMethodForTaskInputOutputContextClass = taskInputOutputContextClass.getMethod("getCounter",
              String.class, String.class);

          COUNTER_METHODS_BY_CLASS.put(taskInputOutputContextClass, getCounterMethodForTaskInputOutputContextClass);
        }
      } else {
        MAP_CONTEXT_CONSTRUCTOR = innerMapContextCls.getConstructor(mapCls, Configuration.class, TaskAttemptID.class,
            RecordReader.class, RecordWriter.class, OutputCommitter.class, StatusReporter.class, InputSplit.class);
        MAP_CONTEXT_IMPL_CONSTRUCTOR = null;
        WRAPPED_CONTEXT_FIELD = null;

        COUNTER_METHODS_BY_CLASS.put(taskIOContextCls,
            taskIOContextCls.getMethod("getCounter", String.class, String.class));
      }
  ...
  /**
   * Creates JobContext from a JobConf and jobId using the correct constructor for
   * based on Hadoop version. <code>jobId</code> could be null.
   *
  ...
  /**
   * Invoke getConfiguration() method on JobContext. Works with both Hadoop 1 and
   * 2.
   *
