...
class InternalParquetRecordWriterV1<T> extends InternalParquetRecordWriter<T> {
  private static final Log LOG = Log.getLog(InternalParquetRecordWriterV1.class);
  ...
  private ColumnWriteStoreV1 columnStore;
   ...
   */
  public InternalParquetRecordWriterV1(
    ...
    super(schema, rowGroupSize, pageSize);
  ...
  private void initStore() {
    this.pageStore = new ColumnChunkPageWriteStore(compressor, schema, initialBlockBufferSize);
    this.columnStore = new ColumnWriteStoreV1(pageStore, pageSize, initialPageBufferSize, dictionaryPageSize, enableDictionary, writerVersion);
    MessageColumnIO columnIO = new ColumnIOFactory(validating).getColumnIO(schema);
    this.writeSupport.prepareForWrite(columnIO.getRecordWriter(columnStore));
  }
