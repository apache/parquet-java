...
class InternalParquetRecordWriterV2<T> extends InternalParquetRecordWriter<T> {
  private static final Log LOG = Log.getLog(InternalParquetRecordWriterV2.class);
  ...
  private ColumnWriteStoreV2 columnStore;
   ...
   */
  public InternalParquetRecordWriterV2(
  ...
  private void initStore() {
    ...
    columnStore = new ColumnWriteStoreV2(
        schema,
        pageStore, pageSize, initialPageBufferSize,
  ...
  /* (non-Javadoc)
   * @see parquet.hadoop.InternalParquetRecordWriter#close()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see parquet.hadoop.InternalParquetRecordWriter#write(T)
   */
  @Override
