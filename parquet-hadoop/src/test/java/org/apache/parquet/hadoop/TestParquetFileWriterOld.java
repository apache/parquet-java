...
// TODO - merge this with the file modified in the master branch (with same name except without 'Old' at the end)
public class TestParquetFileWriterOld {
  private static final Log LOG = Log.getLog(TestParquetFileWriterOld.class);
  private String writeSchema;

  @Test
  public void testWriteRead() throws Exception {

    File testFile = new File("target/test/TestParquetFileWriterOld/testParquetFile").getAbsoluteFile();
    testFile.delete();
  ...
  public void testMetaDataFile() throws Exception {
    ...
    File testDir = new File("target/test/TestParquetFileWriterOld/testMetaDataFileDir").getAbsoluteFile();
