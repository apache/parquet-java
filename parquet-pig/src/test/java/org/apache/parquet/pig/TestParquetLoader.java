...
public class TestParquetLoader {
  ...
  public void testSchema() throws Exception {
    ...
    list.add(field);
    field = new RequiredField("b", 0, Arrays.asList(
        new RequiredField("t", 0, Arrays.asList(new RequiredField("d", 1, null, DataType.CHARARRAY)), DataType.TUPLE)),
        DataType.BAG);
    list.add(field);
  ...
  public void testProjectionPushdown() throws Exception {
    ...
    pigServer
        .registerQuery("C = LOAD '" + out + "' using " + ParquetLoader.class.getName() + "('a:chararray, b:int');");
