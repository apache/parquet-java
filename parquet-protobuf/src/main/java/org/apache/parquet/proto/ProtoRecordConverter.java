...
public class ProtoRecordConverter<T extends MessageOrBuilder> extends ProtoMessageConverter {
  ...
  public ProtoRecordConverter(Class<? extends Message> protoclass, MessageType parquetSchema, boolean readFieldById) {
    super(new SkipParentValueContainer(), protoclass, parquetSchema, readFieldById);
    reusedBuilder = getBuilder();
  }

  public ProtoRecordConverter(Message.Builder builder, MessageType parquetSchema, boolean readFieldById) {
    super(new SkipParentValueContainer(), builder, parquetSchema, readFieldById);
    reusedBuilder = getBuilder();
  }
