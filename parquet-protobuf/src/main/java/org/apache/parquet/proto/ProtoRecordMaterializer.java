...
class ProtoRecordMaterializer<T extends MessageOrBuilder> extends RecordMaterializer<T> {
  ...
  public ProtoRecordMaterializer(MessageType requestedSchema, Class<? extends Message> protobufClass, boolean readSpecsCompliant) {
    this.root = new ProtoRecordConverter<T>(protobufClass, requestedSchema, readSpecsCompliant);
  }
