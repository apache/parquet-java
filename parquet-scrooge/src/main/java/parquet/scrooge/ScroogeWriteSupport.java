 ...
 */
public class ScroogeWriteSupport<T extends ThriftStruct> extends ThriftWriteSupport<T> {
  ...
  public static Class<? extends ThriftStruct> getScroogeClass(Configuration configuration) {
    return (Class<? extends ThriftStruct>)ThriftWriteSupport.getThriftClass(configuration);
  }
