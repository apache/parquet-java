...
public class TestThriftMetaData {
   ...
   * but there is no guarantee that that class is on the classpath, and it is in
   * fact normal for that to be the case (for example, when a file was written
   * with TBase objects but is being read with scrooge objects).
   *
   * See PARQUET-345
   */
  @Test
