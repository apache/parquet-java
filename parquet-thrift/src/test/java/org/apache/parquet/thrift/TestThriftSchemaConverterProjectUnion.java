...
public class TestThriftSchemaConverterProjectUnion {
  ...
  /**
   * An optional union inside a required struct should still be dropped if not
   * selected.
   */
  @Test
  ...
  /**
   * A required union inside of an un-selected optional struct should get dropped
   * along with the optional struct.
   */
  @Test
  ...
  /**
   * A required union inside a selected optional struct should keep one sentinel
   * column for each "kind" of union member.
   */
  @Test
  ...
  public void selectingOneUnionMemberKeepsSentinels() {
    shouldGetProjectedSchema("aUnion/structV4/addedStruct/gender", "aUnion.structV4.addedStruct.gender",
   ...
   * even though the fields will be "optional" because of how unions are stored,
   * we still need to grab sentinel columns from the members of the union.
   */
  @Test
  public void testUnionInsideUnion() {
    ...
    shouldGetProjectedSchema("unionOfStructs/structV4/addedStruct/gender", "unionOfStructs.structV4.addedStruct.gender",
        "message ParquetSchema {\n" + "  optional group structV3 = 1 {\n" + "    required binary name (UTF8) = 1;\n"
            + "  }\n" + "  optional group unionOfStructs = 2 {\n" + "    optional group structV3 = 1 {\n"
            + "      required binary name (UTF8) = 1;\n" + "    }\n" + "    optional group structV4 = 2 {\n"
            + "      optional group addedStruct = 4 {\n" + "        optional binary gender (UTF8) = 3;\n" + "      }\n"
    ...
    shouldGetProjectedSchema("unionV2/aLong/**", "unionV2.aLong",
  ...
  public void testListOfUnions() {
    ...
    // selecting a field from an optional list of unions should also choose a
    // sentinel field
    // for the rest of the union members
    // at the same time, this should also drop the required list of unions, because
    // it is safe to
    // drop even a required but repeated group
    shouldGetProjectedSchema("optListUnion/structV3/age", "optListUnion.structV3.age",
    ...
    shouldGetProjectedSchema("reqListUnion/structV3/age", "reqListUnion.structV3.age",
  ...
  public void testMapWithUnionKey() {
    shouldGetProjectedSchema("optMapWithUnionKey/key/**", "optMapWithUnionKey.key",
    ...
    shouldGetProjectedSchema("optMapWithUnionKey/key/**;optMapWithUnionKey/value/gender",
  ...
  public void testMapWithUnionValue() {
    shouldGetProjectedSchema("optMapWithUnionValue/key/**;optMapWithUnionValue/value/structV4/addedStruct/gender",
