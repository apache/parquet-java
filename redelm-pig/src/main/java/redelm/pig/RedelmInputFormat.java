...
public class RedelmInputFormat extends PigFileInputFormat<Object, Tuple> {
  ...
  public RedelmInputFormat(String requestedSchema) {
      try {
          ...
          throw new RuntimeException("Unable to parse requestedSchema: " + requestedSchema, e);
      }
  }
  ...
  public RecordReader<Object, Tuple> createRecordReader(
      ...
      return new RecordReader<Object, Tuple>() {
          ...
          public void initialize(InputSplit inputSplit, TaskAttemptContext taskAttemptContext)
            ...
            String schemaString = redelmInputSplit.getSchema();
            try {
                schema = RedelmParser.parse(schemaString);
            } catch (RecognitionException e) {
                throw new RuntimeException("Unable to parse RedelmInputSplit schema: " + schemaString, e);
            }
